...
PumsFile <- "C:/Users/jyen/Downloads/PUMS/data/California/REVISEDPUMS5_06.TXT" #PUMS5 revised in 2010.
...
#code (San Diego example)
#GetPumas <- c("08101", "08102", "08103", "08104", # PUMA Code
#              "08105", "08106", "08107", "08108",
#              "08109", "08110", "08111", "08112",
#              "08113", "08114", "08116", "08116")

GetPumas <- c("06701","06702","06703","06704","06705") # SuperPUMA Code for San Diego County
...
write.table(
  H_df, 
  file = "../output/pums_households.csv", 
  row.names = FALSE,
  col.names = TRUE,
  sep = ",")
